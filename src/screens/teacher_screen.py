...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Username", placeholder="ananya123")
...
def teacher_screen_register():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username", placeholder="ananya123")
    ...
    teacher_confirm_pass = st.text_input("Confirm password", placeholder="Confirm your password", type="password")

    st.divider()

    btnc1, btnc2 = st.columns(2, gap="large")
    with btnc1:
        if st.button("Register", icon=":material/passkey:", shortcut="enter", width='stretch' ):
