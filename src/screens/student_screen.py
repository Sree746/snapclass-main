...
def student_dashboard():
    ...
    c1, c2 = st.columns(2)
    with c1:
        st.header('Your Enrolled Subejcts')
    with c2:
...
def student_screen():
    ...
    st.markdown('<style>div[data-testid="stCameraInput"] button {background-color: #5865f2 !important; color: white !important; border-radius: 8px !important; border: none !important; font-weight: bold !important;}</style>', unsafe_allow_html=True)  
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="E.g. Sree Janani")
